...
<body>
      ...
      <a class="navbar-brand" href="index.php"><img src="./Images/logo.png" width="55" height="35" class="d-inline-block align-text-top"></a>
          <div class="navbar-header">
            <a href="index.php" class="navbar-brand active">LIBRARY MANAGEMENT SYSTEM</a>
          </div>
